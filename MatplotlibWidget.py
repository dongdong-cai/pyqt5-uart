...
class MyMplCanvas(FigureCanvas):
    ...
    def start_static_plot(self,x,y,x_title='',y_title='',lable=''):
        self.fig.suptitle('串口数据绘制')
        self.axes.cla()
        self.axes.plot(x,y,'r',ls='-',lw=3,label=lable,alpha=0.8)
...
if __name__ == '__main__':
    ...
    ui = MatplotlibWidget()
    ui.mpl.start_static_plot([1,2,3],[4,5,6])  # 测试静态图效果
